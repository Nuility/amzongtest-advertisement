...
- Python 3.13+
- Node.js 18+ 或 Docker
- MySQL 8.0+ (Docker容器或本地安装)
- Redis 7+ (Docker容器或本地安装)
...
pip install cryptography  # MySQL连接必需
```
...
- **[完整使用手册](docs/USER_MANUAL.md)** - 包含安装部署、配置说明、使用方法、API指南、常见问题等
...
- `doc/summary260512.md` - 2026-05-12项目检查与部署总结
...
**严重问题 (8个) ✅**
1. Campaign/Keyword模型性能指标字段已补全
2. Keyword模型is_negative字段已添加
3. 竞价历史old_bid逻辑已修复
4. 依赖包PyJWT、passlib等已补全
5. 前端API调用方法已修正
6. 数据库事务异常处理已添加
7. 导入错误全部修复
8. TypeScript类型定义已添加
...
**配置问题 (5个) ✅**
1. Pydantic v2配置语法已适配
2. pyproject.toml格式已修复
3. 环境变量配置已创建
4. JWT密钥验证已配置
5. 日志路径已修正
